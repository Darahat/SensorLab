...
- **Files:**
  ...
  - `lib/src/features/noise_meter/models/acoustic_report.dart` - Hive models with type adapters
  - `lib/src/features/noise_meter/services/acoustic_report_service.dart` - Database service layer
...
- **File:** `lib/src/features/noise_meter/presentation/providers/enhanced_noise_meter_provider.dart`
...
- **File:** `lib/src/features/noise_meter/models/enhanced_noise_data.dart`
- **New Fields Added:**
...
- **Features:**
  ...
  - **Auto-navigation:** Returns to previous screen with report on completion
...
├── models/
│   ├── acoustic_report.dart (Hive models)
│   └── enhanced_noise_data.dart (State models with id field)
├── services/
...
│   └── screens/
│       ├── acoustic_preset_selection_screen.dart (3 presets)
